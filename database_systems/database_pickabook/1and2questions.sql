...
#1) Write SQL statements to create tables for your database application. Pick suitable data types for each attribute. For each table, specify primary key and indicate foreign key if any.
CREATE TABLE Users (
...
#2)Write SQL statements to populate each table in your database with at least 10records.
...
INSERT INTO cart VALUES (1,2,'6 days'),(2,4,'2 days'),(3,5,'7 days'),(4,11,'1 day'),(5,12,'1 day'),(6,15,'2 weeks'),(7,16,'3 days'),(8,11,'1 day'),(9,4,'1 day'),(10,2,'2 days');
;
...
INSERT INTO book_review VALUES (1,1112,2,'never read this book',3),
