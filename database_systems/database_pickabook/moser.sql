...
CREATE TABLE `Users` (
  ...
  `user_username` varchar(45) DEFAULT NULL UNIQUE,
...
#INSERT INTO `Users` VALUES (1,'sowmya','satyavada','1234','sowmya@gmail.com','seller/buyer'),(2,'scott','moser','1234','scott@gmail.com','buyer'),(3,'harsha','sree','1234','harsha@gmail.com','seller/buyer'),(4,'john','P','1234','jonh@gmail.com','buyer'),(5,'Li','Lin','1234','li@seattleu.edu','buyer'),(6,'Zin','Zhu','1223','zin@su.edu','seller'),(7,'Oh','seila','4568','oh@su.edu','buyer'),(8,'shivani','patinani','9876','shivani.yahoo.co.in','seller/buyer'),(9,'rutu','bhatt','7654','rutu@gmail.com','seller'),(10,'adam','tanaous','3456','adam@gmail.com','buyer'),(11,'osama','johma','9873','osama@gmail.com','buyer'),(12,'mark','hu','3456','mark.hu@gmiail.com','buyer'),(13,'chi','wang','3456','chi@expedia.com','seller'),(14,'namesh','kair','4567','nameh@gmail.com','seller/buyer'),(15,'dan','lao','2567','dan@gmail.com','buyer'),(16,'liz','johnson','1234','liz@gmail.com','seller');
INSERT INTO `Users` VALUES (1,'sowmya','satyavada','sowmyas1','1234','sowmya@gmail.com','seller/buyer'),(2,'scott','moser','mosers1','1234','scott@gmail.com','buyer'),(3,'harsha','sree','sreeh1','1234','harsha@gmail.com','seller/buyer'),(4,'john','P','Pjohn1','1234','jonh@gmail.com','buyer'),(5,'Li','Lin','1234','LinL1','li@seattleu.edu','buyer'),(6,'Zin','Zhu','ZhuZ1','1223','zin@su.edu','seller'),(7,'Sheila','Oh','OhS1','4568','oh@su.edu','buyer'),(8,'shivani','patinani','patinanis1','9876','shivani.yahoo.co.in','seller/buyer'),(9,'rutu','bhatt','bhattr1','7654','rutu@gmail.com','seller'),(10,'adam','tanaous','tanaousa1','3456','adam@gmail.com','buyer'),(11,'osama','johma','johmao1','9873','osama@gmail.com','buyer'),(12,'mark','hu','hum1','3456','mark.hu@gmiail.com','buyer'),(13,'chi','wang','wangc1','3456','chi@expedia.com','seller'),(14,'namesh','kair','kairn1','4567','nameh@gmail.com','seller/buyer'),(15,'dan','lao','laod1','2567','dan@gmail.com','buyer'),(16,'liz','johnson','johnsonl1','1234','liz@gmail.com','seller');
...
INSERT INTO `authors` VALUES (1,'Henry','Bothell','Fielding'),(2,'Samuel','Bothell','Richardson'),(3,'Jonathan','Seattle','Swift'),(4,'Daniel','New York','Defoe'),(5,'John','New York','Bunyan'),(6,'Benjamin','New Jersey','Disraeli'),(7,'Thomos','New Jersey','Cormen'),(8,'sedney','Oregon','sheldon'),(9,'galye','Oregon','mcdowel'),(10,'alane','Oregon','moore');
...
INSERT INTO `book_author` VALUES (1112,1),(1234,2),(1920,3),(1314,4),(1516,5),(2021,6),(2223,7),(5678,8),(1718,9),(8910,10);
...
# Do we need to populate linking tables?
...
CREATE TABLE `book_review` (
  ...
  # Do we want to add this to the ERD?
...
CREATE TABLE `line_item` (
  ...
  #CONSTRAINT `book_id` FOREIGN KEY (`book_isbn`) REFERENCES `books` (`book_isbn`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `line_item` VALUES (1,123,1112,100,3,300),(2,234,1234,100,2,200),(3,432,1718,100,1,100),(4,543,2223,200,6,1200),(5,546,1516,300,1,300),(6,876,5678,600,1,600),(7,367,8910,400,3,600),(8,234,1314,300,2,600),(9,543,1920,500,5,2500),(10,789,2021,200,5,2500);
...
INSERT INTO `order_status` VALUES (1,NULL,'completed','delivered','2025-06-12'),(2,NULL,'cancelled','pending','2019-06-12'),(3,NULL,'cancelled','pending','2018-01-18'),(4,NULL,'completed','delivered','2012-12-11'),(5,NULL,'completed','shipping','2025-06-12'),(6,NULL,'completed','delivered','2017-04-21'),(7,NULL,'completed','shipping','2023-06-21'),(8,NULL,'cancelled','pending','2025-06-12'),(9,NULL,'completed','shipping','2017-04-21'),(10,NULL,'completed','delivered','2017-04-22');
...
INSERT INTO `orders` VALUES (1,1,'2017-08-11',234,34,268),(2,2,'2016-08-13',45,5,50),(3,5,'2001-08-16',123,23,126),(4,7,'2013-08-09',543,43,586),(5,4,'2016-12-20',20,20,40),(6,10,'2012-07-06',290,12,302),(7,6,'2011-12-09',534,23,557),(8,9,'2019-08-16',876,31,907),(9,8,'2010-07-17',1345,54,1399),(10,3,'2006-05-06',32,1,33);
...
INSERT INTO `shipping_address` VALUES (1,3,'618 203rd st SE',12343,'wa'),
(11,2,'11811 Willows Road',98052,'wa'),
(2,4,'16725 205rd st sw',34565,'wa'),(3,5,'18726 78rd ',34565,'wa'),
(4,2,'123 658 rd st SW',32455,'ca'),(5,7,'address1',34565,'wa'),
(6,11,'address9',98003,'fl'),(7,12,'address6',98012,'ny'),
(8,13,'address3',54678,'nj'),(9,14,'address1',34565,'or'),
(10,15,'address2',23986,'ca'),(11,2,'11811 Willows Road',98052,'wa');
...
-- Dump completed on 2017-11-20 23:27:57
...
#################################################################################
# Query #1: Use inner "JOIN" to Find all shipping addresses for each user
#################################################################################
DROP VIEW IF EXISTS v1;  # Allow script to be run multiple times

# Creating a view that can be used for subsequent queries
CREATE VIEW v1 AS SELECT *
FROM Users JOIN shipping_address USING (user_id);

# For debugging...
#SELECT * FROM v1;

SELECT user_id, user_first_name, user_last_name, ship_street_addr, ship_zip_code,
	ship_state
FROM v1
ORDER BY user_id;

#################################################################################
# Query #2: Use "COUNT" to count the number of shipping addresses for each user
#################################################################################
SELECT user_id, user_first_name, user_last_name, COUNT(ship_id) as NUM_SHIP_ADDR
FROM v1
GROUP BY user_id;

#################################################################################
# Query #3: Use a subquery to...
#################################################################################
